...
export type GetFormInputValue<InputType> = InputType extends FormInputType.String
    ? string
    : InputType extends FormInputType.Boolean
    ? boolean
    : InputType extends FormInputType.Number
    ? number
    : never;
...
export function reactiveForm<
    InputTypes extends Record<keyof InputMultis, FormInputType>,
    InputMultis extends Record<keyof InputTypes, boolean>
>(inputs: GetFormInputDefinitions<InputTypes, InputMultis>): MagicForm<InputTypes, InputMultis> {
