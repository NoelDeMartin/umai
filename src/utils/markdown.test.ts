    ...
    it('renders basic markdown', () => {
        ...
        const expectedHTML = `
            ...
            <p>body with <a
                ...
                target="_blank"
                class="core-link no-underline hover:underline focus-visible:outline-none focus-visible:ring-2 text-primary-700 focus-visible:ring-primary-200 focus-visible:bg-primary-200 "
            >link</a></p>
            <ul>
                <li>One</li>
                <li>Two</li>
